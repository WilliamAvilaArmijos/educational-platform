...
const CourseStudentExamsScore = () => {
  ...
  useEffect(() => {
    ...
    const getExamsScore = async () => {
      setIsLoading(true);

      try {
        const response = await fetch(
          `${process.env.REACT_APP_BASE_URL}/api/exams/course/${params.cid}/user/${params.eid}`,
          {
            headers: {
...
export default CourseStudentExamsScore;
